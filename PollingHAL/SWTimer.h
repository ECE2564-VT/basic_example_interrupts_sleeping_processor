...
// should parameterize their variables to this #define and thus #include <PollingHAL/SWTimer.h>.
 ...
 *
 * [UPDATES]
 * - As of March 30, 2021, the SWTimer library has been updated so that, upon construction, the
 *   timer is already considered to have expired.
 * =================================================================================================
 * USAGE WARNINGS
 * =================================================================================================
